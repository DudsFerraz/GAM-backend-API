...
import br.org.gam.api.Entities.events.generic.services.getEvent.SpringGetEvent;
...
class SpringGetEventTest {
    ...
    @InjectMocks
    private SpringGetEvent getEvent;
    ...
    class Functional {
        ...
        void visibleEventIdShouldReturnEventResponse() {
            ...
            when(getEventInstance.entityById(id)).thenReturn(entity);
            ...
            verify(getEventInstance).entityById(id);

...
import br.org.gam.api.Entities.member.services.searchMembers.SpringSearchMembers;
...
class SpringSearchMembersTest {
    ...
    @InjectMocks
    private SpringSearchMembers searchMembers;

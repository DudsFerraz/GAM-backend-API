...
import br.org.gam.api.Entities.account.services.searchAccounts.SpringSearchAccounts;
...
class SpringSearchAccountsTest {
    ...
    @InjectMocks
    private SpringSearchAccounts searchAccounts;

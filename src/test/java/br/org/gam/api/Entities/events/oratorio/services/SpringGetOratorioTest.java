...
import br.org.gam.api.Entities.events.oratorio.services.getOratorio.SpringGetOratorio;
...
class SpringGetOratorioTest {
    ...
    @InjectMocks
    private SpringGetOratorio getOratorio;
    ...
    class Structural {
        ...
        void springUseCaseImplementationShouldBeServiceComponent() {
            assertThat(SpringGetOratorio.class).hasAnnotation(Service.class);
        }
    }
}

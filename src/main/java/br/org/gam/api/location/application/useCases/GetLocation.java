...
public class GetLocation {
    ...
    private final LocationEntityLoader getLocationInstance;
    private final LocationMapper locationMapper;
    private final LocationRepository locationRepo;

    public GetLocation(LocationEntityLoader getLocationInstance, LocationMapper locationMapper, LocationRepository locationRepo) {

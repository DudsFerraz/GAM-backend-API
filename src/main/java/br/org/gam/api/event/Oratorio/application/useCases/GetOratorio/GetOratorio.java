...
public class GetOratorio {
    ...
    public GetOratorio(OratorioMapper oratorioMapper, GetEventInstance getEventInstance, EventSecurity eventSecurity, GetOratorioInstance getOratorioInstance) {
